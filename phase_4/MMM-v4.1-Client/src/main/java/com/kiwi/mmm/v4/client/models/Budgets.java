...
public class Budgets 
{
    ...
    public Budgets(Map<Categories, Double> categoryAmounts, String selectedCategory, double selectedAmount) 
    {
    ...
    public void setBudgetForCategory(Budgets userBudget, Categories category, double amount) {
