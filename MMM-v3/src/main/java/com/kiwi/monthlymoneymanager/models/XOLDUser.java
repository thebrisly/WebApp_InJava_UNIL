...
public class XOLDUser 
{
    ...
    public XOLDUser(String name, String username, String email, String selectedCategory, String password, double income, List<Operations> operationsList) 
    {
        this.name =     name;
