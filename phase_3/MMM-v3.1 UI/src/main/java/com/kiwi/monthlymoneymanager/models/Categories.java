...
@NamedQueries({
    ...
    @NamedQuery(name = "Categories.findAllUniqueNames", query = "SELECT DISTINCT c.name FROM Categories c"),
...
public class Categories implements Serializable {
    ...
    @ManyToMany(mappedBy = "categoriesCollection1")
    ...
    public String toString() {
        return "com.kiwi.monthlymoneymanager.models.Categories[ categoryId=" + categoryId + " ]";
    }
